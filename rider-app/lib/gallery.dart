...
Map<String, WidgetBuilder> get _screens => {
      ...
      'task-pickup': (_) => TaskDetailScreen(task: mockTasks[1]),
      'task-zone': (_) => TaskDetailScreen(task: mockTasks[2]),
      'batch-scan': (_) => BatchScanScreen(task: mockTasks[2], zone: true),
      'new-ticket': (_) => const RiderNewTicketScreen(),
