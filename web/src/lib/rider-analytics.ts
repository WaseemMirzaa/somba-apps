...
export const riderTaskBreakdown = [
  ...
  { type: "COD collection", typeFr: "Encaissement COD", count: 8, pct: 44 },
...
export const riderRecentActivity = [
  { time: "8 min ago", timeFr: "Il y a 8 min", text: "Delivered ORD-2024-089 — COD $42", textFr: "Livré ORD-2024-089 — COD 42 $" },
