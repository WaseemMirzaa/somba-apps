...
export const returnEntities: ReturnEntity[] = [
  {
    ...
    refund: { amount: 129, method: "Original Payment", methodFr: "Paiement d'origine", status: "pending", statusFr: "En attente" },
    timeline: [
  ...
  },
  {
    ...
    refund: { amount: 129, method: "Original Payment", methodFr: "Paiement d'origine", status: "completed", statusFr: "Terminé" },
    timeline: [
