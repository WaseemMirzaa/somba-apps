...
export const PORTALS = [
  {
    ...
    featuresFr: ["Catégories, recherche et ventes flash", "Achat invité et portefeuille Somba", "Suivi de commande et retours faciles"],
    trust: [
  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        icon: "RotateCcw",
        items: ["Returns processing", "Replacements", "Exchanges", "Payment reconciliation"],
        itemsFr: ["Traitement retours", "Remplacements", "Échanges", "Rapprochement paiements"],
      },
    ],
  },
  {
    ...
    featuresFr: ["File livraisons actives", "Navigation et appel clients", "Preuve de livraison et paiements"],
    trust: [
    ...
    modules: [
      ...
      },
      {
        ...
        items: ["Daily earnings", "Payments collected", "Incentive bonuses", "Payout history"],
        itemsFr: ["Gains quotidiens", "Paiements encaissés", "Bonus incitatifs", "Historique paiements"],
      },
    ],
  },
] as const;
