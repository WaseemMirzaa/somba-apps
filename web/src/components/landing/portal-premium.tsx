...
function PublicPortalCard({
  ...
  return (
    <Link
      href={cta.href}
      className={cn(
        "group relative isolate flex flex-col overflow-hidden rounded-lg bg-clip-padding [backface-visibility:hidden] border border-[var(--border)] bg-white shadow-none transition-all duration-300 hover:-translate-y-1 hover:border-[var(--primary)]/30 hover:shadow-xl max-lg:transition-none lg:rounded-2xl lg:shadow-sm",
...
function OpsPortalCard({
  ...
  return (
    <button
      ...
      className="group isolate flex w-full flex-col overflow-hidden rounded-lg bg-clip-padding [backface-visibility:hidden] border border-slate-200 bg-slate-50/80 text-left transition-all hover:border-[var(--primary)]/25 hover:bg-white hover:shadow-md max-lg:transition-none lg:rounded-xl"
    >
