...
function PublicPortalCard({
  ...
  return (
    <Link
      href={cta.href}
      className={cn(
        "group relative flex flex-col overflow-hidden rounded-none border border-[var(--border)] bg-white shadow-none transition-all duration-300 hover:-translate-y-1 hover:border-[var(--primary)]/30 hover:shadow-xl lg:rounded-2xl lg:shadow-sm",
...
function OpsPortalCard({
  ...
  return (
    <button
      ...
      className="group flex w-full flex-col overflow-hidden rounded-none border border-slate-200 bg-slate-50/80 text-left transition-all hover:border-[var(--primary)]/25 hover:bg-white hover:shadow-md lg:rounded-xl"
    >
