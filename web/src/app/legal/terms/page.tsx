...
export default function TermsPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 prose prose-slate">
      ...
      <p>{fr
        ? "Nous acceptons les paiements par carte Stripe et le mobile money (Airtel, Orange, M-Pesa)."
        : "We support Stripe card payments and mobile money (Airtel, Orange, M-Pesa)."}</p>
      <h2>{fr ? "3. Retours et remboursements" : "3. Returns & Refunds"}</h2>
      <p>{fr
        ? "Les remboursements sont effectués sur le moyen de paiement d'origine, conformément à notre politique de retour."
        : "Refunds are issued to the original payment method, subject to our Return Policy."}</p>
