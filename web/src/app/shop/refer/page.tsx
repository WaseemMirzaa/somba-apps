  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8">
      <PageHeader
        ...
        subtitle={fr ? "Invitez vos amis — gagnez du crédit portefeuille sur leur première commande" : "Invite friends — earn wallet credit on their first order"}
      ...
      <div className="card-premium bg-gradient-to-br from-violet-50 to-blue-50 p-8 text-center">
        ...
        <p className="mt-2 text-sm text-slate-600">{fr ? "Votre ami obtient $10 de réduction. Vous gagnez $10 de crédit portefeuille." : "Your friend gets $10 off. You earn $10 wallet credit."}</p>
      ...
      <div className="card-premium p-6">
        ...
        <ol className="mt-4 space-y-3 text-sm text-slate-600">
          ...
          <li>{fr ? "3. Les deux reçoivent $10 de crédit portefeuille sous 48h" : "3. Both receive $10 wallet credit within 48h"}</li>
        </ol>
      </div>
    </div>
  );
